...
1. How to add Superscript (to a variable) into a cell in google sheet.(refer Superscript.gs)
    ...
    The CHAR() function (Google sheets built-in function),to which the numerical values(ASCII codes 0:8304) corresponding to superscript of a number is passed as an arguement,gives the desired corresponding character value (eg:1<sup>0</sup>).
